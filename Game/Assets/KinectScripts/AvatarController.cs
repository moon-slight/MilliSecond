...
public class AvatarController : MonoBehaviour
{
    ...
    private bool check;                     //盾牌生成與否
    private Vector3 correct;                //修正盾牌位置
    private Vector3 movevar;                //移動量
    private Vector3 moveposition;           //暫存前一次位移的點

    private int current_position;
    private Vector3 targetrel;
    ...
    public GameObject Character1_LeftHand;
    /////
    ...
    {
        current_position = 5;
        targetrel = new Vector3(0, 0, 0);
        temp = new Vector3(0, 0, 0);
        moveposition = new Vector3(0, 0.8f, 1.1f);
        ///
        ...
        check = false;
        correct = new Vector3(-1, 0, 1);                //左手位置往前幾公分
        movevar = new Vector3(-7.5f, -0.1f, -6f);         //改變位置後需要位移量
    ...
    public void UpdateAvatar(Int64 UserID)
    {
        ...
        leftShoulderPos = kinectManager.GetJointPosition(UserID, (int)KinectInterop.JointType.ShoulderLeft);
        //Debug.Log("hand" + leftHandPos.y + ".......shouder" + leftShoulderPos.y);
    ...
    protected void MoveAvatar(Int64 UserID)
    {
        ...
        Vector3 shieldspawn = ShieldSpawn.transform.position + correct;
        if(leftHandPos.y > leftShoulderPos.y && check == false)
        {
            //生成
            GameObject Shield = Instantiate(Shieldobject, shieldspawn, new Quaternion(180, 0, 90, 0)) as GameObject;
            //GameObject Shield = Instantiate(Shieldobject, shieldspawn,  Quaternion.Euler(45,45, 0), Character1_LeftHand.transform) as GameObject;
            
            Shield.transform.parent = Character1_LeftHand.transform;
            Shield.transform.rotation = Quaternion.Euler(0, 90, 90);

            //GameObject Shield = Instantiate(Shieldobject, Character1_LeftHand.transform) as GameObject;
            check = true;
        }
        if(leftHandPos.y < leftShoulderPos.y)
        {
        ...
        */
        ...
        //Vector3 trans;
        //trans = kinectManager.GetUserPosition(UserID);  // normal狀態下
        //if (!moving && change)
        //{
        //    trans = kinectManager.GetUserPosition(UserID) + movevar;    //更改過的狀態
        //}


        //if (moving)
        //{
        //    moveposition = Vector3.MoveTowards(moveposition, target, 10 * Time.deltaTime * 1 / Time.timeScale);
        //    trans = moveposition;
        //    if (trans == target)
        //        moving = false;
        //}

        //if (/*GameSystem.wiimote.Button.d_left*/  Input.GetKeyDown("z") && change == false)  // 移過去B點
        //{

        //    //target = new Vector3(-7.5f, 0.0f, -6f);
        //    target = trans + movevar;
        //    moving = true;
        //    change = true;
        //}

        //if (/*GameSystem.wiimote.Button.d_left*/  Input.GetKeyDown("x") && change == true)  // 移回原位(A點)
        //{
        //    target = kinectManager.GetUserPosition(UserID);
        //    moving = true;
        //    change = false;
        //}
        ...
        //temp1 = kinectManager.GetUserPosition(UserID);
        //trans = kinectManager.GetUserPosition(UserID);
        //if (!moving && current_position != 5)
        //{
        //    //trans = kinectManager.GetUserPosition(UserID) + targetrel;
        //    trans = trans + targetrel;
        //}

        //if (moving)
        //{
        //    moveposition = Vector3.MoveTowards(moveposition, temp, 10 * Time.deltaTime * 1 / Time.timeScale);
        //    trans = moveposition;
        //    if (trans == temp)
        //        moving = false;
        //}
        //if (GameSystem.wiimote.Button.d_left && !moving)
        //{
        //    if (current_position != 0)
        //    {
        //        current_position -= 1;
        //        target = Player.moving_position[current_position] - Player.moving_position[5];
        //        targetrel.x = target.x / 4;
        //        targetrel.y = 0f;
        //        targetrel.z = -1 * target.z;
        //        temp = temp1 + targetrel;
        //        moving = true;
        //    }

        //}

        //if (GameSystem.wiimote.Button.d_right && !moving)
        //{
        ...
        //}
        //Debug.Log("1........" + current_position);
        //Debug.Log("2" + target);
        //Debug.Log("3" + temp);
        //Debug.Log("4" + moveposition);
        /////////////////////////////////////////////////////////////////
        ...
        //Debug.Log("**123" + bodyRootPosition);
        ...
        //Debug.Log("000" + bodyRootPosition);
        ...
        else
        {
            transform.position = smoothFactor != 0f ?
                Vector3.Lerp(transform.position, targetPos, smoothFactor * Time.deltaTime) : targetPos;   // 走此
        }
    }
